...
library("MuMIn")
r.squaredGLMM(mod.int)
r.squaredGLMM(mod.field)
r.squaredGLMM(mod.field2)
r.squaredGLMM(mod.field3)
r.squaredGLMM(mod.field4)
r.squaredGLMM(mod.time)
r.squaredGLMM(mod.time2)
r.squaredGLMM(mod.time3)
r.squaredGLMM(mod.field.time)
r.squaredGLMM(mod.gulls)
r.squaredGLMM(mod.wad)
r.squaredGLMM(mod.earth)
