...
# # for replication:
trip.sample <- c(2345, 3108, 2937, 1306, 2107,   3, 2188,  330,  275)
# 
...
plot(points_all_nona.ltraj[c(1,2,8,6)])
dev.off()

win.metafile("trips_300s_int.wmf", width = 7, height = 7)
plot(points_all_nona.ltraj.300[c(1,2,8,6)])
dev.off()
