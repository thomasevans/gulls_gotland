...
# Plots for figure 4 - veg height stuff -----
# a
...
# c
# Name crops
levels(field$crop3) <- c("Roots", "Grass", "Cereals" ,"Ryegrass", "Other")
# Sort levels (alphabetically)
field$crop3 <- factor(field$crop3,sort(levels(field$crop3)))
# Plot
...
# GPS foraging trips by month + year ------
...
barplot(monthyear, xlab="Month", ylab="Proportion terrestrial foraging trips (%)", ylim=c(0,100), 
        ...
        cex.axt = 1.2,
        cex.names = 1.2)
axis(1, at = c(2.5,6.5,10.5), labels = FALSE,      cex.lab = 1.2,
     cex.axt = 1.2, cex.names = 1.2)
axis(2, at=seq(0,100,10),  las=1,      cex.lab = 1.2,
     cex.axt = 1.2, cex.names = 1.2)
legend("topright", c("2011", "2012", "2013"), cex=1.2, col=c("gray1", "gray47", "gray87"), 
